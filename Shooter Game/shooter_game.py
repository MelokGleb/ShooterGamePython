...
#playerpic = 'rocket.png'
#alien = 'ufo.png'
#bullet = 'bullet.png'
#rock = 'asteroid.png'
#def randfloat(a, b):
#    c = randint(a, b) + random()
#    return c
#
#
#points = 0
...
#mixer.music.play()
#
#ship = Player(playerpic, 5, win_height - 100, 80, 100, 10)
#monsters = sprite.Group()
#asteroids = sprite.Group()
#for i in range(1, 6):
#    monster = Enemy(alien, randint(80, win_width - 80), -40, 80, 50, randfloat(1, 5))
#    monsters.add(monster)
#for i in range (1, 3):
#    asteroid = Astero(rock, randint(30, win_width - 30), -40, 80, 50, randfloat(4, 8))
...
#
#    if not finish:
#        text = font1.render('Счёт:' + str(points), 1, (255, 255, 255))
#        text2 = font1.render('Пропущено:' + str(skipped), 1, (255, 255, 255))
...
#                reloadtext = font1.render('Перезарядка 3 секунды', 1, (150, 0, 0))
...
#            monster = Enemy(alien, randint(80, win_width - 80), -40, 80, 50, randfloat(1, 5))
#            monsters.add(monster)
#        if sprite.spritecollide(ship, monsters, False) or sprite.spritecollide(ship, asteroids, False) or skipped > max_skipped:
#            finish = True
...
monsters = sprite.Group()
for i in range(1, 6):
    monster = Enemy(img_enemy, randint(80, win_width - 80), -40, 80, 50, randfloat(1, 3))
    monsters.add(monster)
...
asteroids = sprite.Group()
for i in range(1, 3):
    asteroid = Meteor(img_ast, randint(30, win_width - 30), -40, 80, 50, randfloat(6, 8))
    asteroids.add(asteroid)
   ...
   #событие нажатия на кнопку “Закрыть”
    ...
    if not finish:
        ...
        if rel_time == True:
            ...
            if now_time - last_time < 1.5: #пока не прошло 3 секунды выводим информацию о перезарядке
